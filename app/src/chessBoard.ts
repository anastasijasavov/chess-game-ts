import { getByID, isKingInCheck, isWhite } from "./figureRules";
...
function handleDragEnd(e: any) {
  ...
  const possibleCheckMoves = draggedFigure.checkPossibleDestinations();
  if (isKingInCheck(possibleCheckMoves)) console.log("you just gave a check");
  //treba se proveri i dal je sah mat
